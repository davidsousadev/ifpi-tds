...
def estatisticas_populacao(salarios, filhos):
    if (type(salarios)!=list or type(filhos)!=list) or (len(salarios)==0 or len(filhos)==0) or (len(salarios)!=len(filhos)):
        return Exception
...
# Testes
assert estatisticas_populacao([300, 500, 400, 350], [2, 3, 1, 4]) == (387.5, 2.5, 500, 50.0)
